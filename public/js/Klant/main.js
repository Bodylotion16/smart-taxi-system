...
/* ==========================================================================
   MAP INITIALISATIE (Alleen uitvoeren als de map container bestaat)
   ========================================================================== */
...
function setupAutocomplete(inputId, listId, isPickup) {
    ...
    if (!input || !list) return; // Stop als elementen niet op de pagina staan
